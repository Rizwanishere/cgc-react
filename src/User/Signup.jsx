  ...
  return (
    <div className="flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <h1 className="font-bold text-2xl mb-8 text-center">Create Your Account</h1>
        ...
        <div className="flex flex-col space-y-4 mb-4">
          ...
          <button className="flex items-center justify-center bg-white text-black border border-gray-300 px-4 py-2 rounded focus:outline-none">
            <FaGoogle className="mr-2 text-blue-500" /> Sign up with Google
          </button>
        </div>
        ...
        <form onSubmit={onSignup}>
          <div className="mb-4">
            ...
            <ShouldRender when={errors.firstName}>
              <div className="text-sm text-red-500 mt-1">{errors.firstName}</div>
            </ShouldRender>
          </div>
